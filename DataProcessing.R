...
data_confirmed <- read.csv("../COVID-19_Analysis/data/time_series_covid19_confirmed_global.csv",sep=',', head=TRUE,check.names =FALSE )
data_deceased <- read.csv("../COVID-19_Analysis/data/time_series_covid19_deaths_global.csv",sep=',', head=TRUE,check.names =FALSE)
data_recovered <- read.csv("../COVID-19_Analysis/data/time_series_covid19_recovered_global.csv",sep=',', head=TRUE,check.names =FALSE)
data_weather <- read.csv("../COVID-19_Analysis/data/covid_weather_dataset.csv")
